...
<head>
    <title>吃掉徐佳乐</title>
    <meta itemprop="name" content="吃掉徐佳乐" />
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
            ...
            <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://github.com/arcyourgrandfatherccc/EatKano'">开源</button>
        </div>
    </div>
    </div>
